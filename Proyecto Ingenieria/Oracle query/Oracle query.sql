...
---------------------------------------------------------
   ...
   CREATE SEQUENCE  "PROYECTO"."CARS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence CUSTOMERS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "PROYECTO"."CUSTOMERS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence EMPLOYEES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "PROYECTO"."EMPLOYEES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "PROYECTO"."INVOICES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence ORDERS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "PROYECTO"."ORDERS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SUPPLIERS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "PROYECTO"."SUPPLIERS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence USERS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "PROYECTO"."USERS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "PROYECTO"."CARS" 
   (	"ID" NUMBER(19,0), 
	...
	"YEAR" NUMBER(4,0), 
	"TRANSMISSION" VARCHAR2(255 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "PROYECTO"."INVENTORY" 
   (	"ID" NUMBER(19,0), 
	"CAR_ID" NUMBER(19,0), 
...
SET DEFINE OFF;
Insert into PROYECTO.CARS (ID,MODEL,YEAR,TRANSMISSION,COLOR) values ('21','mODEL YZ','2026','Neutro','Verde Agua');
Insert into PROYECTO.CARS (ID,MODEL,YEAR,TRANSMISSION,COLOR) values ('41','Toyota Corolla','2021','Automatic','Blue');
Insert into PROYECTO.CARS (ID,MODEL,YEAR,TRANSMISSION,COLOR) values ('9','Modelo X','2025','Manual','Verde');
Insert into PROYECTO.CARS (ID,MODEL,YEAR,TRANSMISSION,COLOR) values ('2','Modelo Z','2026','Automatico','Azul');
Insert into PROYECTO.CARS (ID,MODEL,YEAR,TRANSMISSION,COLOR) values ('4','mODELO X','2027','Neutra','Amarillo');
Insert into PROYECTO.CARS (ID,MODEL,YEAR,TRANSMISSION,COLOR) values ('0','Model X','2025','Automatico','Azul');
...
SET DEFINE OFF;
Insert into PROYECTO.CUSTOMERS (ID,NAME,CEDULA,BIRTH_DATE,PHONE,ADDRESS) values ('1','Juan Pérez','12345678',to_date('15/05/80','DD/MM/RR'),'555-1234','123 Calle Principal');
Insert into PROYECTO.CUSTOMERS (ID,NAME,CEDULA,BIRTH_DATE,PHONE,ADDRESS) values ('0','Sebastian Coto Arias','305610818',to_date('21/11/24','DD/MM/RR'),'61951300','Cartago');
REM INSERTING into PROYECTO.EMPLOYEES
SET DEFINE OFF;
Insert into PROYECTO.EMPLOYEES (ID,EMPLOYEE_NAME,"position",SALARY,HIRE_DATE,LAST_NAME,CEDULA,PHONE,EMAIL) values ('0','Sebastian','Empleado','400',to_date('12/11/24','DD/MM/RR'),'Coto Arias','305610818','61951300','secoto12@gmail.com');
Insert into PROYECTO.EMPLOYEES (ID,EMPLOYEE_NAME,"position",SALARY,HIRE_DATE,LAST_NAME,CEDULA,PHONE,EMAIL) values ('3','Michael Arias','Jefe','6000000',to_date('12/11/24','DD/MM/RR'),'Coto','30235565','86651236','micel@hotmail.com');
Insert into PROYECTO.EMPLOYEES (ID,EMPLOYEE_NAME,"position",SALARY,HIRE_DATE,LAST_NAME,CEDULA,PHONE,EMAIL) values ('6','Nicole','Jefa','300000',to_date('12/11/24','DD/MM/RR'),'Arias','30235676576573','61024861','nic5@otmail.com');
Insert into PROYECTO.EMPLOYEES (ID,EMPLOYEE_NAME,"position",SALARY,HIRE_DATE,LAST_NAME,CEDULA,PHONE,EMAIL) values ('2','Jacamo','Lider','30000',to_date('12/11/24','DD/MM/RR'),'Fernado','10542023','123','Jacamillo@.dsf.com');
REM INSERTING into PROYECTO.INVENTORY
SET DEFINE OFF;
Insert into PROYECTO.INVENTORY (ID,CAR_ID,QUANTITY) values ('0','41','10');
REM INSERTING into PROYECTO.INVOICES
SET DEFINE OFF;
REM INSERTING into PROYECTO.ORDERS
SET DEFINE OFF;
Insert into PROYECTO.ORDERS (ID,ORDER_NUMBER,CUSTOMER_NAME,CAR_MODEL,ORDER_STATUS,ORDER_DATE) values ('0','Numero 566','Sebastian Coto','Model XY','EN proceso',to_date('13/11/24','DD/MM/RR'));
REM INSERTING into PROYECTO.USERS
SET DEFINE OFF;
Insert into PROYECTO.USERS (ID,USERNAME,PASSWORD,ROLE,CREATED_AT,CUSTOMER_ID) values ('1','secoto1227@gmail.com','Hirafasd1','Cliente',to_timestamp('28/11/24 12:45:23,398000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),null);
...
--------------------------------------------------------
  ...
  ALTER TABLE "PROYECTO"."INVENTORY" MODIFY ("QUANTITY" NOT NULL ENABLE);
  ALTER TABLE "PROYECTO"."INVENTORY" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "PROYECTO"."CARS" MODIFY ("MODEL" NOT NULL ENABLE);
  ALTER TABLE "PROYECTO"."CARS" MODIFY ("YEAR" NOT NULL ENABLE);
  ALTER TABLE "PROYECTO"."CARS" MODIFY ("TRANSMISSION" NOT NULL ENABLE);
  ALTER TABLE "PROYECTO"."CARS" MODIFY ("COLOR" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "PROYECTO"."INVENTORY" ADD FOREIGN KEY ("CAR_ID")
